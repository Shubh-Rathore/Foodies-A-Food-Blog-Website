...
class RestaurantCreateForm(forms.ModelForm):
    ...
    tax = forms.IntegerField(widget=forms.NumberInput(attrs={'class': 'form-control','placeholder':'Tax in %'}))
    ...
    class Meta:
        model = Restaurant
        fields = ['title','image','categories','location','price','tax','taste','persons','details']
